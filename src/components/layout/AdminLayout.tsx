...
import {
  ...
  BarChart3, Sun, Moon, LogOut, Menu, X, ChevronLeft,
  Tag, Ticket, MessageSquare, Key
} from 'lucide-react';
...
const sidebarItems = [
  ...
  { icon: BarChart3, label: 'Keuangan', path: '/admin/finance' },
  { icon: Tag, label: 'Voucher', path: '/admin/vouchers' },
  { icon: Ticket, label: 'Support', path: '/admin/support' },
  { icon: Key, label: 'License', path: '/admin/licenses' },
  { icon: MessageSquare, label: 'Review', path: '/admin/reviews' },
